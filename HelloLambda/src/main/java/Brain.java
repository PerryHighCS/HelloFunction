...
public class Brain extends Actor {
	...
	/**
	 * Contemplates the meaning of existence; and display the number of brains in
	 * this cell.
	 */
	@Override
	public void act() {
	 ...
	 * 
	 * @param num
	 *            the new number of brains in the pile
	 */
	...
	/**
	 * Remove one brain from this pile. If this is the last brain, remove the pile
	 * from the world.
	 */
