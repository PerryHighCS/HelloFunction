...
public abstract class World {
    ...
    /**
     * Create a rectangular world with given dimensions, with square locations
     * of a given size.
     *
     * @param worldWidth
     * @param worldHeight
     ...
     * @param x the location to add the actor
     * @param y the location to add the actor
     */
     ...
     *
     * @param <A>
     * @param cls The type of objects to get (null for any)
     * @return
     */
     ...
     * @param failFill The color to fill the sprite with if loading fails
     * @return
     */
